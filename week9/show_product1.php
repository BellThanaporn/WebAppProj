...
if(mysqli_num_rows($result)>0){
    ...
    echo "<td><a href='add_product1.php?id=".$row["id"]."'>ใส่ตระกร้า</td></tr>";
    }
    echo "</table>";
}else{
    echo "0 results";
...
echo "<table><tr><th>ลำดับ</th><th>id</th><th>name</th><th>description</th><th>price</th></tr>";
    for($i=0;$i<count($_SESSION["cart"]);$i++)
    {
        ...
        echo "<td><a href='del_cart1.php?i=".$i."'>";
        echo "<font color='red'>X</font></a><td></tr>";

        $total+=$item['price'];
    }
echo "</table>";
echo "<h3><a href ='del_all1.php'>ลบรายการทั้งหมด</a></h3>";
echo "<h1>ราคาสินค้า $total บาท</h1>";
echo "<h2><a href ='checkout1.php'>สั่งซื้อ</a></h2>";
}
mysqli_close($con);
?>